...
public class ControllerTestConfiguration {
    ...
    public MockMvc mockMvc(InventarioControllerREST inventarioControllerREST, PersonajeControllerREST personajeControllerREST) {
        return MockMvcBuilders.standaloneSetup(inventarioControllerREST, personajeControllerREST).build();
    }
}